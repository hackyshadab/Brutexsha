...
```
Facebook tools keep getting more and more accessible to beginners, and the Brutexsha Tool 
...
* Brutexsha Framework only supports two OS.

```
Brutexsha Framework only supports two 
operating systems - Kali Linux and Termux!
```


## Brutexsha Tool installation
...
people we created Brutexsha Framework password protection.
```
